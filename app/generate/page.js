    ...
    <div className='min-h-screen grid grid-cols-1 lg:grid-cols-[12fr_13fr]'>
      <div className='col1 flex flex-col w-full justify-center items-center gap-4'>
        ...
        <div className='flex flex-col pt-4 gap-5'>
          <input className='bg-[rgb(246,247,245)] h-12 rounded-lg px-3 border-2 border-transparent hover:border-[rgb(219,220,218)]' placeholder='linktr.ee/username' type='text'/>
          ...
          <button className='bg-purple-700 text-white text-xl font-bold py-3 rounded-full hover:bg-purple-900 cursor-pointer'>Continue</button>
