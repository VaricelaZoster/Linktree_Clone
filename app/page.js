      ...
      <section className="grid grid-cols-2 bg-[rgb(37,79,26)] min-h-[120vh]">
        <div className="flex flex-col gap-4 justify-center ml-[10vw]">
          ...
          <div className="flex gap-2 pt-10">
            <input value={username} onChange={(e) => setUsername(e.target.value)} className="bg-white px-2 py-2 focus:outline-green-500 rounded-lg" placeholder="linktr.ee/your-url" type="text"></input>
            <button onClick={() => handleClaim()} className="bg-pink-200 rounded-full p-4 cursor-pointer">Claim your Linktree</button>
          </div>
        </div>
