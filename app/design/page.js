  ...
  return (
    <div className="flex justify-center items-center bg-[rgb(250,249,254)] h-screen">
      <div className="flex flex-col justify-center items-center h-screen sm:h-200 w-120">
        <div className="flex text-[rgb(184,175,243)] border-x-2 border-t-2 border-t-[rgb(184,175,243)] border-x-[rgb(184,175,243)] h-80 w-full justify-center items-center text-5xl font-extrabold rounded-t-3xl p-4">
          {user.toUpperCase()}
        </div>
